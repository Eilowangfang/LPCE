					 ...
					 List *restrictlist)
{
    ...
    //elog(INFO, "     ------> LPCE add_paths_to_joinrel add_paths_to_joinrel outer: %ld, inner: %ld", outerrel->relids->words[0], innerrel->relids->words[0]);
	/*
	 ...
	 */
    //elog(INFO, "     ------> LPCE add_paths_to_joinrel sort_inner_and_outer");
	 ...
	 */
    //elog(INFO, "     ------> LPCE add_paths_to_joinrel match_unsorted_outer");
	if (mergejoin_allowed)
					 ...
					 JoinPathExtraData *extra)
{
	...
	foreach(l, all_pathkeys)
	{
		...
		merge_pathkeys = build_join_pathkeys(root, joinrel, jointype,
											 outerkeys);
        //elog(INFO, "     ------>------> LPCE sort_inner_and_outer sort_inner_and_outer");
		/*
