...
create_scan_plan(PlannerInfo *root, Path *best_path, int flags)
{
    ...
    //elog(INFO, "     ------> LPCE SCAN SCAN relids &&&&&&&&&&&&&&&& %ld", best_path->parent->relids->words[0]);
	/*
...
create_material_plan(PlannerInfo *root, MaterialPath *best_path, int flags)
{
    ...
    //LPCE
    plan->plan.outer_relids = best_path->subpath->parent->relids->words[0];;
					 ...
					 NestPath *best_path)
{
    ...
    //elog(INFO, "     ------> LPCE NESTED best_path->jpath.outerjoinpath->parent !!!!!!!!!!!!!! %ld", best_path->outerjoinpath->parent->relids->words[0]);
    //elog(INFO, "     ------> LPCE NESTED best_path->jpath.innerjoinpath->parent !!!!!!!!!!!!!! %ld", best_path->innerjoinpath->parent->relids->words[0]);
					  ...
					  MergePath *best_path)
{
    ...
    //elog(INFO, "     ------> LPCE MERGE best_path->jpath.outerjoinpath->parent %ld", best_path->jpath.outerjoinpath->parent->relids->words[0]);
    //elog(INFO, "     ------> LPCE MERGE best_path->jpath.innerjoinpath->parent %ld", best_path->jpath.innerjoinpath->parent->relids->words[0]);
	/*
					 ...
					 HashPath *best_path)
{
	...
	hashclauses = get_switched_clauses(best_path->path_hashclauses,
									   best_path->jpath.outerjoinpath->parent->relids);
    //elog(INFO, "     ------> LPCE best_path->jpath.outerjoinpath->parent !!!!!!!!!!!!!! %ld", best_path->jpath.outerjoinpath->parent->relids->words[0]);
    //elog(INFO, "     ------> LPCE best_path->jpath.innerjoinpath->parent !!!!!!!!!!!!!! %ld", best_path->jpath.innerjoinpath->parent->relids->words[0]);
	/*
