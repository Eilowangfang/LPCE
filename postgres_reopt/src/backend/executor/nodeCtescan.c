...
ExecInitCteScan(CteScan *node, EState *estate, int eflags)
{
    ...
    elog(INFO,"     ------>------> LPCE ExecInitCteScan %d", scanstate->ss.ps.plan->plan_node_id);
	/*
...
{
    elog(INFO,"     ------>------> LPCE ExecEndCteScan",node->cteplanstate->plan->plan_node_id);
	/*
	 * Free exprcontext
	 */
...
ExecReScanCteScan(CteScanState *node)
{
    ...
    elog(INFO,"     ------>------> LPCE ExecReScanCteScan");
	/*
