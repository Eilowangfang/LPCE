...
ExecIndexScan(PlanState *pstate)
{
	...
	//LPCE
    card_runLog[node->ss.ps.plan->plan_node_id].node_card++;
...
ExecEndIndexScan(IndexScanState *node)
{
    ...
    elog(INFO, "     ------>------> LPCE ExecEndIndexScan");
	/*
...
ExecInitIndexScan(IndexScan *node, EState *estate, int eflags)
{
    ...
    elog(INFO, "     ------> LPCE ExecInitIndexScan at node %ld estimate tuples %.0f", indexstate->ss.ps.plan->plan_node_id, indexstate->ss.ps.plan->plan_rows);
	/*
