...
ExecEndIndexOnlyScan(IndexOnlyScanState *node)
{
    ...
    elog(INFO, "     ------>------> LPCE ExecEndIndexOnlyScan");
...
ExecInitIndexOnlyScan(IndexOnlyScan *node, EState *estate, int eflags)
{
    ...
    elog(INFO, "     ------> LPCE ExecInitIndexOnlyScan at node %ld estimate tuples %.0f", indexstate->ss.ps.plan->plan_node_id, indexstate->ss.ps.plan->plan_rows);
    //elog(INFO, "     ------> LPCE ExecInitIndexOnlyScan ExecInitIndexOnlyScan !!!!!!  %ld", indexstate->ss.ps.plan->outer_relids);
	/*
