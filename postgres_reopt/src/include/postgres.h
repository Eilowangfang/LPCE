 ...
 * ----------------------------------------------------------------
 */
#define NODE_NUM_MAX 30
#define BASEREL_NUM_MAX 15

extern bool LPCECheck;
extern bool LPCERerun;
extern bool LPCEEarlyStop;

extern bool testPurpose;
...
extern struct baseRel_Estimate_Card{
    int     relids;
    double estimate_card;
}baseRel_EstimateCard[BASEREL_NUM_MAX];
