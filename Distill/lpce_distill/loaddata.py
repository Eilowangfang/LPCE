...
def load_train_data(path, selected_sample):
    feature = []
    adjacency_list = []
    node_order = []
    edge_order = []
...
class Dataloader(data.Dataset):
    ...
    def __init__(self, path, selected_sample, isTest):
        super(Dataloader, self).__init__()
        tmp_features, tmp_adjacency_list, tmp_node_order, tmp_edge_order, tmp_label = load_train_data(path, selected_sample)
