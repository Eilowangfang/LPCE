...
"Query execution example" shows an query example running on native PostgreSQL and PostgreSQL using LPCE, in which execution time is reduced from  to 2.18s.
