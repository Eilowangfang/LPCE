...
#define CONFIGURE_ARGS " '--prefix=/home/dbgroup/postgres/pg13_lql'"
...
#define PG_VERSION_STR "PostgreSQL 13.9 on x86_64-pc-linux-gnu, compiled by gcc (Ubuntu 9.4.0-1ubuntu1~18.04) 9.4.0, 64-bit"
