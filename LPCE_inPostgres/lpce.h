...
typedef enum
{
	...
	AQO_MODE_DISABLED,
    /*LPCE provides cardinality estimation for search plan before query execution*/
	LPCE_LEARNED,
}	AQO_MODE;
...
typedef enum
{
    /*LPCE provides cardinality estimation for search plan before query execution*/
    LPCE_MODE_INIT,
    /* Progressive mode to do*/
}	LPCE_MODE;




extern int lpce_mode;
extern int	aqo_mode;
...
/* Fang edit
extern double card_value[];
 /* Cardinality estimation from learned model*/
