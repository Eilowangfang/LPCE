# Trinaer for LPCE-R (conntect layer A)
...
class HyTrainer(object):
    ...
    def __init__(self, cuda, cardModule, contentModule, refineModule, optimizer, min_label, max_label):
        super(HyTrainer, self).__init__()
        self.cuda_use = cuda
        self.modela = cardModule
        self.modelb = contentModule
