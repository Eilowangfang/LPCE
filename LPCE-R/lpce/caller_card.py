...
class Caller_CardModule(object):

    def __init__(self, cuda, model, min_label, max_label, operat_dim, tb_dim, filter_dim, join_dim, card_dim):
        super(Caller_CardModule, self).__init__()
        self.cuda_use = cuda
        self.model = model
