...
if __name__ == '__main__':
    ...
    #real_info = "110,426103,110,426103,64,120743,46,855021,4,12743,42,6598,32,269129,10,6598,2,1246,8,6598,"
    #real_info = "22,120743,22,120743,18,6598,4,2609129,18,6598,2,0,16,6598,"
    ...
    for relid in planNodes:
        ...
        if node.card >= 0:
           cardResult.append(format(planNodes[relid].card, '.1f'))
    ...
    print("Total estimated cardinality : ", len(cardResult), " ", vaildNum)
